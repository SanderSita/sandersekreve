...
export default function Footer() {
  return (
    <div className="w-full flex justify-between border-t border-t-[#252625] rounded-t-md lg:rounded-md bottom-0 lg:absolute sticky text-gray-400 z-50 bg-black">
      <div className="flex">
        <a
          href="https://github.com/SanderSita/sandersekreve"
          className="p-1 flex gap-1 px-2 hidden md:flex"
        >
          <svg
            stroke="currentColor"
            fill="currentColor"
        ...
        <span className="p-1 border-l border-l-[#252625] px-2 hidden md:flex">
          <i className="bi bi-arrow-repeat my-auto"></i>
        </span>
        <span className="p-1 border-l border-l-[#252625] px-2 flex gap-1 hidden md:flex">
          <i className="bi bi-x-circle my-auto"></i>0
          <i className="bi bi-exclamation-triangle"></i>0
        </span>

        <span
          href="mailto:sandersekreve@gmail.com"
          className="p-1 border-l border-[#252625] px-2 flex gap-1 hover:text-white hidden md:flex"
        >
        ...
        <span
          href="https://www.linkedin.com/in/sander-sekreve-2880aa189/"
          target="_blank"
          className="p-1 flex gap-1 px-2 border-l border-l-[#252625] hover:text-white"
        >
        ...
        <span
          href="https://github.com/SanderSita"
          target="_blank"
          className="p-1 flex gap-1 px-2 border-l border-r border-[#252625] hover:text-white"
        >
      ...
      <div className="hidden md:flex">
        <span className="p-1 px-2 border-r border-l border-[#252625] flex gap-1">
